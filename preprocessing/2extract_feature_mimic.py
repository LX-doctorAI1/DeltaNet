...
def main(args):
    ...
    for subset in ['train', 'val', 'test']:
        ...
        for subject_id in data:
            ...
            for study in studys:
                patient_files.append(study['path'][:-3] + 'jpg')

    already_save = glob(args.output + '/*npy')
    with torch.no_grad():
        for patient_file in tqdm(patient_files):
            patient_name = os.path.basename(patient_file)[:-4]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--root', type=str, default="/home/shuxinyang/data/mimic/finding",
                        help="the begin directory of all")
    parser.add_argument('--pair', type=str, default="/home/shuxinyang/data/mimic/finding/pair_list.json",
                        help="the begin directory of all")
    parser.add_argument('-d', '--data', type=str, default="/home/shuxinyang/data/mimic/finding/images/",
                        help="image file path")
    parser.add_argument('-o', '--output', type=str, default="/home/shuxinyang/data/mimic/features",
