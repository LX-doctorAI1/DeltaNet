...
def get_simi(args, split_file, topk=10):
    ...
    for subset in ['train', 'val', 'test']:
        ...
        for subject_id in tqdm(data):
            ...
            for i, study in enumerate(studys):
                ...
                if subset == 'train' and i == 0:
                    # select all condition from train set and first case
                    file_split['retrieve'].append(study['path'])
    ...
    csv_filename = osp.join(args.output, 'similar_pair_list.csv')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--split', type=str, default="/home/shuxinyang/data/mimic/finding/pair_list.json",
                        help="split file")
