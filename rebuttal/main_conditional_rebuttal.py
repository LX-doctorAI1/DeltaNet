...
from Models.ConcatFeat import Encoder2DecoderIcRc
...
def validation(args, model, data_loader, vocab, epoch, mode='val'):
    ...
    json.dump(results, open(resFile, 'w'), ensure_ascii=False)
...
def main(args):
    ...
    model = Encoder2DecoderIcRc(args.embed_size, len(vocab), args.hidden_size, args.N)
